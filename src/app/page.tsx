...
export default function Home() {
  ...
  return (
    <main>
      ...
      <section className="contact" id="contact"><div className="shell"><p className="section-label">Have a project in mind?</p><h2>Let&apos;s build something<br /><span>that wins online.</span></h2><a className="primary-button" href="mailto:contact@websitedesigner.ng">Start Your Project <Arrow /></a></div></section>
